...
#import "UITableView+WWExtension.h"
#import <objc/runtime.h>

@implementation UITableView (WWExtension)
#pragma mark - init
+ (void)load
{
...
- (void)setWw_foldable:(BOOL)ww_foldable
{
    ...
    if(ww_foldable && !self.ww_foldState){
        ...
        NSInteger sectionsNum = [self.dataSource numberOfSectionsInTableView:self];
        for(NSInteger index=0;index<sectionsNum;index++){
